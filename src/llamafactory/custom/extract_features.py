...
if __name__ == '__main__':
    ...
    parser.add_argument("--query", type=str, default="Identify the emotional types of this meme (humor, sarcasm, offensive, motivational).")   
    parser.add_argument('--data_split', type=str,
                            default='train test', help='Evaluate on which dataset split')
    ...
    parser.add_argument('--topk', type=int, default=-1, help='Set the topk value')
    ...
    parser.add_argument(
        "--EXP_FOLDER",
        type=str,
        default="./data/Embedding/qwen2vl-7b/",
    ...
    elif args.dataset.lower() == "memotion":
        args.gt_folder = './data/gt/m7k_taskB/'
        args.image_folder = './data/image/m7k/All/'
        args.dataset = "Memotion"
    ...
    # 在主脚本中初始化 processor
    # processor = AutoProcessor.from_pretrained(args.processor_path, max_pixels=448*448)

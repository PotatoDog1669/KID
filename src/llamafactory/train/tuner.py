...
# KID classifier stages
from .sft_classifier import run_sft_classifier
from .sft_classifier_multiclass import run_sft_classifier_multiclass
from .sft_classifier_multilabel import run_sft_classifier_multiclabel
...
def _training_function(config: dict[str, Any]) -> None:
    ...
    elif finetuning_args.stage == "sft-classifier_multiclass":
        run_sft_classifier_multiclass(model_args, data_args, training_args, finetuning_args, generating_args, callbacks)
    elif finetuning_args.stage == "sft-classifier_multilabel":
        run_sft_classifier_multiclabel(model_args, data_args, training_args, finetuning_args, generating_args, callbacks)
    elif finetuning_args.stage == "sft-meme_multiclass":
        run_sft_meme_multiclass(model_args, data_args, training_args, finetuning_args, generating_args, callbacks)
    else:
